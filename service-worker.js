const CACHE_NAME = 'alevel-materials-v7';
const APP_SHELL = [
  './','./index.html','./styles.css?v=3','./upgrade-v3.css?v=3','./learning-system-v4.css?v=4','./visual-overhaul-v5.css?v=5','./visual-overhaul-v6.css?v=6','./simulation-studio-v7.css?v=7','./materials-data.js?v=2','./textbook-visuals-v3.js?v=3','./textbook-part1-v3.js?v=3','./textbook-part2-v3.js?v=3','./extended-bank-v3.js?v=3','./app.js?v=2','./simulation-upgrade-v3.js?v=3','./exam-coach-v3.js?v=3','./learning-system-v4.js?v=4','./lesson-visuals-v5.js?v=5','./three-lab-v5.js?v=5','./lesson-depth-v6.js?v=6','./simulation-lab-v6.js?v=6','./textbook-depth-v6.js?v=6','./simulation-studio-v7.js?v=7','./netlify-runtime.js?v=2','./manifest.webmanifest','./physics-icon.svg','./offline.html'
];
